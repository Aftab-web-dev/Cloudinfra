  ...
  categories: [
    ...
    },
    {
      ...
      components: [
        ...
        { id: 'aws-mq', type: 'aws-mq', provider: 'aws', category: 'Messaging', name: 'Amazon MQ', description: 'Managed RabbitMQ / ActiveMQ broker', icon: 'MessageSquare', color: '#E7157B' },
        { id: 'aws-msk', type: 'aws-msk', provider: 'aws', category: 'Messaging', name: 'MSK (Kafka)', description: 'Managed Streaming for Apache Kafka', icon: 'Layers', color: '#E7157B' },
        { id: 'aws-iot-core', type: 'aws-iot-core', provider: 'aws', category: 'Messaging', name: 'IoT Core (MQTT)', description: 'Managed MQTT broker for IoT', icon: 'Radio', color: '#E7157B' },
